...
namespace WebApplicationDePrueba2.Repository
{
    public class ADO_Producto
    {
        ...
        {
            //Recibe un producto con su número de Id, lo modifica con la nueva información.
        ...
        {
            // Recibe el número de Id de un producto a eliminar y lo elimina de la base de datos.
            ...
            using (SqlConnection connect = new SqlConnection(connectionString))
            {
                ...
                SqlCommand cmd = connect.CreateCommand();
                cmd.CommandText = "DELETE FROM ProductoVendido WHERE IdProducto = @Id DELETE FROM Producto WHERE Id = @Id";
        ...
        {
            //Método que trae todos los productos cargados en la base de datos.
